...
<div class="DivGlobal clearfix">
	...
	<div class="Content">
		<div class="item-title">
			...
			<c:if test="${role == 'logical' && user == 'logical'}">
		...
		<div class="item-title-sub">
			...
			<span>角色名称：<input type="text" id="query_post" name="query_post" value="<c:out value='${query_post}'/>"/></span>
				...
				<c:choose>
					<c:when test="${i % 2 == 0}">
						<tr>
							...
							<td><span class="tab-w2"><c:choose><c:when test="${data.rolename != null}"><c:out value="${data.rolename}"/></c:when><c:otherwise><c:out value="${data.role}"/></c:otherwise></c:choose></span></td>
					...
					<c:otherwise>
						<tr>
							...
							<td class="tds01"><span class="tab-w2"><c:choose><c:when test="${data.rolename != null}"><c:out value="${data.rolename}"/></c:when><c:otherwise><c:out value="${data.role}"/></c:otherwise></c:choose></span></td>
