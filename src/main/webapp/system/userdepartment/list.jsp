...
<div class="DivGlobal clearfix">
	...
	<div class="Content">
		<div class="item-title">
			...
			<c:if test="${department == 'logical' && user == 'logical'}">
				...
				<c:choose>
					<c:when test="${i % 2 == 0}">
						<tr>
							...
							<td><span class="tab-w2"><c:choose><c:when test="${data.departmentname != null}"><c:out value="${data.departmentname}"/></c:when><c:otherwise><c:out value="${data.department}"/></c:otherwise></c:choose></span></td>
					...
					<c:otherwise>
						<tr>
							...
							<td class="tds01"><span class="tab-w2"><c:choose><c:when test="${data.departmentname != null}"><c:out value="${data.departmentname}"/></c:when><c:otherwise><c:out value="${data.department}"/></c:otherwise></c:choose></span></td>
