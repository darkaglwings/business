...
<div class="DivGlobal clearfix">
	...
	<div class="Content">
		<div class="item-title">
			...
			<c:if test="${post == 'logical' && user == 'logical'}">
				...
				<c:choose>
					<c:when test="${i % 2 == 0}">
						<tr>
							...
							<td><span class="tab-w2"><c:choose><c:when test="${data.postname != null}"><c:out value="${data.postname}"/></c:when><c:otherwise><c:out value="${data.post}"/></c:otherwise></c:choose></span></td>
					...
					<c:otherwise>
						<tr>
							...
							<td class="tds01"><span class="tab-w2"><c:choose><c:when test="${data.postname != null}"><c:out value="${data.postname}"/></c:when><c:otherwise><c:out value="${data.post}"/></c:otherwise></c:choose></span></td>
